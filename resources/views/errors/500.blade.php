...
<body class="min-h-screen bg-slate-950 text-white">
    <div class="mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center px-6 py-12 text-center">
        <div class="rounded-[2rem] border border-white/10 bg-slate-900/90 p-10 shadow-2xl backdrop-blur-sm">
            <p class="text-sm uppercase tracking-[0.35em] text-emerald-300">Server Error</p>
            <h1 class="mt-6 text-6xl font-black tracking-tight text-white">500</h1>
            <p class="mt-6 text-xl font-semibold text-slate-200">Something went wrong.</p>
            <p class="mt-4 max-w-2xl text-sm leading-7 text-slate-400">The server encountered an unexpected error. Please try again later or head back to safety.</p>
